...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_NAV_LOITER_UNLIM=17, /* Loiter around this waypoint an unlimited amount of time |1: Empty| 2: Empty| 3: in meters. If positive loiter clockwise, else counter-clockwise| 4: Desired yaw angle.| 5: Latitude| 6: Longitude| 7: Altitude|  */
   ...
   MAV_CMD_DO_FOLLOW_REPOSITION=33, /* Reposition the MAV after a follow target command has been sent |1: e camera to the tracking device)| 2: Camera q2| 3: Camera q3| 4: Camera q4| 5: altitude offset from target (m)| 6: X offset from target (m)| 7: Y offset from target (m)|  */
   ...
   MAV_CMD_DO_PAUSE_CONTINUE=193, /* If in a GPS controlled position mode, hold the current position or continue. |1: ld current position. 1: Continue mission. A VTOL capable vehicle should enter hover mode (multicopter and VTOL planes). A plane should loiter with the default loiter radius.| 2: Reserved| 3: Reserved| 4: Reserved| 5: Reserved| 6: Reserved| 7: Reserved|  */
   ...
   MAV_CMD_SET_GUIDED_SUBMODE_CIRCLE=4001, /* This command sets submode circle when vehicle is in guided mode. Vehicle flies along a circle facing the center of the circle. The user can input the velocity along the circle and change the radius. If no input is given the vehicle will hold position.
                   |1: Radius of desired circle in CIRCLE_MODE| 2: User defined| 3: User defined| 4: User defined| 5: e in CIRCLE_MODE| 6: Unscaled target longitude of center of circle in CIRCLE_MODE| 7: Reserved (default:0)|  */
   ...
   MAV_CMD_WAYPOINT_USER_2=31001, /* User defined waypoint item. Ground Station will show the Vehicle as flying through this item. |1: User defined| 2: User defined| 3: defined| 4: User defined| 5: Latitude unscaled| 6: Longitude unscaled| 7: Altitude (MSL), in meters|  */
   ...
   MAV_CMD_USER_3=31012, /* User defined command. Ground Station will not show the Vehicle as flying through this item. Example: MAV_CMD_DO_SET_PARAMETER item. |1: User defined| 2: d| 3: User defined| 4: User defined| 5: User defined| 6: User defined| 7: User defined|  */
