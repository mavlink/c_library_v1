...
{
    return mavlink_msg_scaled_pressure_pack_status(system_id, component_id, _status, msg,  scaled_pressure->time_boot_ms, scaled_pressure->press_abs, scaled_pressure->press_diff, scaled_pressure->temperature);
}
