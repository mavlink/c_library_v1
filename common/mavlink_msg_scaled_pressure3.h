...
{
    return mavlink_msg_scaled_pressure3_pack_status(system_id, component_id, _status, msg,  scaled_pressure3->time_boot_ms, scaled_pressure3->press_abs, scaled_pressure3->press_diff, scaled_pressure3->temperature);
}
