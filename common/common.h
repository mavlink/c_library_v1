...
/** @brief This describes the type of a field in an array, for example usage (see ESTIMATOR_STATE) */
#ifndef HAVE_ENUM_MAV_FIELD
#define HAVE_ENUM_MAV_FIELD
typedef enum MAV_FIELD
{
   MAV_FIELD_UNUSED=0, /* Unused state. | */
   MAV_FIELD_POS_N=1, /* Position North, m | */
   MAV_FIELD_POS_E=2, /* Position East, m | */
   MAV_FIELD_POS_D=3, /* Position Down, m | */
   MAV_FIELD_ASL=4, /* Altitude above sea level, m | */
   MAV_FIELD_AGL=5, /* Altitude above ground level, m | */
   MAV_FIELD_VEL_N=6, /* Velocity North, m/s | */
   MAV_FIELD_VEL_E=7, /* Velocity East, m/s | */
   MAV_FIELD_VEL_D=8, /* Velocity Down, m/s | */
   MAV_FIELD_VEL_X=9, /* Velocity body x (forward), m/s | */
   MAV_FIELD_VEL_Y=10, /* Velocity body y (right), m/s | */
   MAV_FIELD_VEL_Z=11, /* Velocity body z (down), m/s | */
   MAV_FIELD_ACC_N=12, /* Acceleration North, m/s | */
   MAV_FIELD_ACC_E=13, /* Acceleration East, m/s | */
   MAV_FIELD_ACC_D=14, /* Acceleration Down, m/s | */
   MAV_FIELD_ACC_X=15, /* Acceleration body x (forward), m/s | */
   MAV_FIELD_ACC_Y=16, /* Acceleration body y (right), m/s | */
   MAV_FIELD_ACC_Z=17, /* Acceleration body z (down), m/s | */
   MAV_FIELD_Q0=18, /* Quaternion from nav to body scalar component | */
   MAV_FIELD_Q1=19, /* Quaternion from nav to body vector[0] component | */
   MAV_FIELD_Q2=20, /* Quaternion from nav to body vector[1] component | */
   MAV_FIELD_Q3=21, /* Quaternion from nav to body vector[2] component | */
   MAV_FIELD_ROLL=22, /* Euler Body 3-2-1 (Tait-Bryan) roll angle, radians | */
   MAV_FIELD_PITCH=23, /* Euler Body 3-2-1 (Tait-Bryan) pitch angle, radians | */
   MAV_FIELD_YAW=24, /* Euler Body 3-2-1 (Tait-Bryan) yaw angle, radians | */
   MAV_FIELD_ANGVEL_X=25, /* Euler Body x rate, radians/second | */
   MAV_FIELD_ANGVEL_Y=26, /* Euler Body y rate, radians/second | */
   MAV_FIELD_ANGVEL_Z=27, /* Euler Body z rate, radians/second | */
   MAV_FIELD_ROLLRATE=28, /* Euler Body 3-2-1 (Tait-Bryan) roll angle rate, radians/second | */
   MAV_FIELD_PITCHRATE=29, /* Euler Body 3-2-1 (Tait-Bryan) pitch angle rate, radians/second | */
   MAV_FIELD_YAWRATE=30, /* Euler Body 3-2-1 (Tait-Bryan) yaw angle rate, radians/second | */
   MAV_FIELD_LAT=31, /* Latitude, radians | */
   MAV_FIELD_LON=32, /* Longitude, radians | */
   MAV_FIELD_BIAS_N=33, /* North bias (normalized) | */
   MAV_FIELD_BIAS_E=34, /* East  bias (normalized) | */
   MAV_FIELD_BIAS_D=35, /* Down z bias (normalized) | */
   MAV_FIELD_BIAS_X=36, /* Body x bias (normalized) | */
   MAV_FIELD_BIAS_Y=37, /* Body y bias (normalized) | */
   MAV_FIELD_BIAS_Z=38, /* Body z bias (normalized) | */
   MAV_FIELD_TERRAIN_ASL=39, /* Altitude of terrain above sea level, m | */
   MAV_FIELD_AIRSPEED=40, /* Airspeed, m/s | */
   MAV_FIELD_FLOW_X=41, /* Optical flow in body x, radians | */
   MAV_FIELD_FLOW_Y=42, /* Optical flow in body y, radians | */
   MAV_FIELD_MAG_X=43, /* Magnetic field, body x, Gauss | */
   MAV_FIELD_MAG_Y=44, /* Magnetic field, body y, Gauss | */
   MAV_FIELD_MAG_Z=45, /* Magnetic field, body z, Gauss | */
   MAV_FIELD_MAG_HDG=46, /* Magnetic heading, radians | */
   MAV_FIELD_DIST_BOTTOM=47, /* Distance bottom, m | */
   MAV_FIELD_DIST_TOP=48, /* Distance top, m | */
   MAV_FIELD_DIST_FRONT=49, /* Distance front, m | */
   MAV_FIELD_DIST_BACK=50, /* Distance back, m | */
   MAV_FIELD_DIST_LEFT=51, /* Distance left, m | */
   MAV_FIELD_DIST_RIGHT=52, /* Distance right, m | */
   MAV_FIELD_ENUM_END=53, /*  | */
} MAV_FIELD;
#endif

/** @brief Sensor type */
#ifndef HAVE_ENUM_MAV_SENSOR_TYPE
#define HAVE_ENUM_MAV_SENSOR_TYPE
typedef enum MAV_SENSOR_TYPE
{
   MAV_SENSOR_TYPE_NONE=0, /* No associated sensor | */
   MAV_SENSOR_TYPE_GPS=1, /* GPS | */
   MAV_SENSOR_TYPE_SONAR=2, /* Sonar | */
   MAV_SENSOR_TYPE_LIDAR=3, /* Lidar | */
   MAV_SENSOR_TYPE_IR=4, /* Infrared ranger | */
   MAV_SENSOR_TYPE_GYRO=5, /* Gyroscope | */
   MAV_SENSOR_TYPE_ACCEL=6, /* Accelerometer | */
   MAV_SENSOR_TYPE_MAG=7, /* Magnetometer | */
   MAV_SENSOR_TYPE_BARO=8, /* Barometric altimeter | */
   MAV_SENSOR_TYPE_PITOT=9, /* Pitot tube | */
   MAV_SENSOR_TYPE_MOCAP=10, /* Motion capture | */
   MAV_SENSOR_TYPE_FLOW=11, /* Optical flow | */
   MAV_SENSOR_TYPE_RGB=12, /* RGB computer vision or camera | */
   MAV_SENSOR_TYPE_DEPTH=13, /* Depth computer vision or camera | */
   MAV_SENSOR_TYPE_THERMAL=14, /* Thermal imaging | */
   MAV_SENSOR_TYPE_TEMPER=15, /* Temperature | */
   MAV_SENSOR_TYPE_HUMID=16, /* Humidity | */
   MAV_SENSOR_TYPE_ENUM_END=17, /*  | */
} MAV_SENSOR_TYPE;
#endif
