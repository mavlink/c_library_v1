...
typedef enum MAV_FIELD
{
   ...
   MAV_FIELD_BIAS_N=33, /* North bias | */
   MAV_FIELD_BIAS_E=34, /* East  bias | */
   MAV_FIELD_BIAS_D=35, /* Down z bias | */
   MAV_FIELD_BIAS_X=36, /* Body x bias | */
   MAV_FIELD_BIAS_Y=37, /* Body y bias | */
   MAV_FIELD_BIAS_Z=38, /* Body z bias | */
...
typedef enum MAV_SENSOR_TYPE
{
   ...
   MAV_SENSOR_TYPE_GYRO=4, /* Gyroscope | */
   MAV_SENSOR_TYPE_ACCEL=5, /* Accelerometer | */
   MAV_SENSOR_TYPE_MAG=6, /* Magnetometer | */
   MAV_SENSOR_TYPE_BARO=7, /* Barometric altimeter | */
