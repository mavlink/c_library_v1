...
{
    return mavlink_msg_mission_clear_all_pack_status(system_id, component_id, _status, msg,  mission_clear_all->target_system, mission_clear_all->target_component);
}
