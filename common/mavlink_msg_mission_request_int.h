...
{
    return mavlink_msg_mission_request_int_pack_status(system_id, component_id, _status, msg,  mission_request_int->target_system, mission_request_int->target_component, mission_request_int->seq);
}
