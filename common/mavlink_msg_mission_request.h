...
{
    return mavlink_msg_mission_request_pack_status(system_id, component_id, _status, msg,  mission_request->target_system, mission_request->target_component, mission_request->seq);
}
