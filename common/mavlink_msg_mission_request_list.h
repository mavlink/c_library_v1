...
{
    return mavlink_msg_mission_request_list_pack_status(system_id, component_id, _status, msg,  mission_request_list->target_system, mission_request_list->target_component);
}
